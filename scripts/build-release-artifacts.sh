...
echo "    4. Publish to Maven:      cd wrappers/kotlin && ANDROID_HOME=\$HOME/Library/Android/sdk ./gradlew buildNativeLibs publishAllPublicationsToMavenCentralRepository"
