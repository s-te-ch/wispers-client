...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.9.0-rc1/CWispersConnect.xcframework.zip",
            checksum: "6903940761d32677590be361bef1ff876fb7aa184230b0b954c64e70a6f2e925"
        ),
        .target(
            name: "WispersConnect",
