...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.2-rc1/CWispersConnect.xcframework.zip",
            checksum: "7674be191e2f791aac8412c0ea85cb71bf9f496b90f5db0487df3cc96b787c91"
        ),
        .target(
            name: "WispersConnect",
