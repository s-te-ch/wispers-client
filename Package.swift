...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.9.0/CWispersConnect.xcframework.zip",
            checksum: "000ff563ba9ec29819be87458de77eda3b192d99ee04488d513722718efe0598"
        ),
        .target(
            name: "WispersConnect",
