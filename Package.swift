...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.13.0/CWispersConnect.xcframework.zip",
            checksum: "4902a819bb14061526b4ff65c408071e3ca7e78adbce32dcf721a6aa3254c29b"
        ),
        .target(
            name: "WispersConnect",
