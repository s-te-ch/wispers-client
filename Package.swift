...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.0-rc5/CWispersConnect.xcframework.zip",
            checksum: "ca927474e390e1625e1099fd21fbd884fd8e1174b1329b34f632f72f93f3d61a"
        ),
        .target(
            name: "WispersConnect",
