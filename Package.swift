...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.8.1-rc3/CWispersConnect.xcframework.zip",
            checksum: "23db5622941208ad32e620d67ffc40765094350d61d13bf8052ba75938005230"
        ),
        .target(
            name: "WispersConnect",
