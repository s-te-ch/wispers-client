...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.15.0/CWispersConnect.xcframework.zip",
            checksum: "ccc8f8943fd6200addd79b6e94ac60372e6c72d0b618342fad067f52878def8a"
        ),
        .target(
            name: "WispersConnect",
