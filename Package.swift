...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.16.0/CWispersConnect.xcframework.zip",
            checksum: "9b34bf7f292cf8c8cb9ed5425edb48599cbdd831624d37184e0d577f383a95e8"
        ),
        .target(
            name: "WispersConnect",
