...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/s-te-ch/wispers-client/releases/download/v0.14.0/CWispersConnect.xcframework.zip",
            checksum: "71548d0212e7496868dc69f742bb4b6997303fd838c22dd2e4a74f2e3fe1f4df"
        ),
        .target(
            name: "WispersConnect",
